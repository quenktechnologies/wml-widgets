...
export class Link extends wml.Component<LinkAttrs> {
    ...
    values = {
        ...
        disabled:
            this.attrs && this.attrs.disabled ? this.attrs.disabled : null,
        ...
        className: concat(
            ...
            this.attrs && this.attrs.disabled ? `-ww-disabled` : ''
        ),

        title: this.attrs && this.attrs.title ? this.attrs.title : null,

        name: this.attrs && this.attrs.name ? this.attrs.name : null,

        href: this.attrs && this.attrs.href ? this.attrs.href : '#',

        target: this.attrs.target,

        active: this.attrs && this.attrs.active ? this.attrs.active : false,
    ...
    deactivate(): Link {
        ...
        if (m.isJust()) m.get().classList.remove(ACTIVE);
