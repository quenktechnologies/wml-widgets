 ...
 * MediaDescription
 */
export class MediaDescription extends Component<MediaDescriptionAttrs> {
 ...
 * Media
 */
export class Media extends Component<MediaAttrs> {
 ...
 * Description
 */
export class Description extends Component<DescriptionAttrs> {
