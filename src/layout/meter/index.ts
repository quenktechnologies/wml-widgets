...
export class MeterBar extends Component<MeterBarAttrs> {
    ...
    values = {
        ...
        value: this.attrs && this.attrs.value ? this.attrs.value : 0,

        color: this.attrs && this.attrs.color ? this.attrs.color : '',
        ...
        style: () => {
            ...
            if (this.values.value) list.push(`width:${this.values.value}%`);
