...
export class Prompt extends Component<PromptAttrs> {
    ...
    values = {
        ...
        footer: {
            close: {
                text:
                    this.attrs && this.attrs.closeText
            ...
            save: {
                text:
                    this.attrs && this.attrs.saveText
                        ? this.attrs.saveText
                        : 'Save',
                ...
                disabled: this.attrs && this.attrs.disabled ? true : false,

                onClick: () => {
                    if (this.attrs && this.attrs.onSave) this.attrs.onSave();
