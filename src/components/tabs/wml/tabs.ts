...
export class TabView<C> extends AppView<C>{
    ...
    constructor(context:C) {
        ...
        this.template = function() {
            return $$node('li',{html:{'role': "presentation",'class': (this.attributes.read('ww:active'))? Styles.ACTIVE : null},wml:{'id': "root"}},[$$node('a',{html:{'href': "#",'onclick': this.clicked.bind(this)},wml:{'id': "link"}},[$$if(this.attributes.read('ww:text'), function if13() {return $$box([this.attributes.read('ww:text')])}.bind(this),  function else_clause6() {return $$box([this.children]);}.bind(this))], view)], view)
        }
...
export class TabsView<C> extends AppView<C>{
    ...
    constructor(context:C) {
        ...
        this.template = function() {
            return $$node('ul',{html:{'class': Styles.TABS}},[this.children], view)
        }
