...
export class TabView<C> extends AppView<C>{
    ...
    constructor(context:C) {
        ...
        this.template = function() {
            return $$node('li',{html:{'role': "presentation",'class': (this.attributes.read('ww:active'))? Styles.ACTIVE : null},wml:{'id': "root"}},[$$node('a',{html:{'href': "#",'onclick': this.clicked.bind(this)},wml:{'id': "link"}},[$$if(this.attributes.read('ww:text'), function if1(){ return $$domify(this.attributes.read('ww:text')) }.bind(this),function else_clause1(){ return $$domify(this.children) }.bind(this))], view)], view)
        }
