...
export class Main  implements __wml.View {
   ...
   constructor(__context: DataTablePage) {
...
__this.widget(new DataTable({wml : { 'id' : __context.values.id  },'sortable': true ,'onCellClicked': __context.values.onCellClicked,'data': __context.values.users,'columns': __context.values.columns}, [

        
     ]),<__wml.Attrs>{wml : { 'id' : __context.values.id  },'sortable': true ,'onCellClicked': __context.values.onCellClicked,'data': __context.values.users,'columns': __context.values.columns})
     ]),<__wml.Attrs>{});
