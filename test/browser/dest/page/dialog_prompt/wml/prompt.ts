...
export class Open  implements __wml.View {
   ...
   constructor(__context: PromptPage  ) {
       ...
       this.template = (__this:__wml.Registry) => {
           ...
           return __this.widget(Prompt, {html : {  } ,wml : { 'id' : `open`  } ,ww : { 'title' : __context.values.title  ,'onSave' : __context.values.onSave  ,'onCancel' : __context.values.onCancel   } }, [

        __this.widget(TextField, {html : {  } ,wml : {  } ,ww : { 'value' : __context.values.value  ,'onChange' : __context.values.onChange   } }, [
