...
export class Main  implements __wml.View {
   ...
   constructor(__context: PaginatorPage  ) {

       this.template = (__this:__wml.Registry) => {

           return __this.widget(Demo, {html : {  } ,wml : {  } }, [

        __this.widget(Paginator, {html : {  } ,wml : {  } ,ww : { 'total' : __context.values.total  ,'current' : __context.values.current  ,'onChange' : __context.values.onChange   } }, [
