...
export class Main  implements __wml.View {
   ...
   constructor(__context: ButtonGroupPage  ) {
       ...
       this.template = (__this:__wml.Registry) => {
        ...
        __this.widget(ButtonGroup, {html : {  } ,wml : {  } }, [

        __this.widget(Button, {html : {  } ,wml : {  } ,ww : { 'text' : `one`  } }, [

        
     ]),
__this.widget(Button, {html : {  } ,wml : {  } ,ww : { 'text' : `three` ,'active' : true   } }, [

        
     ]),
__this.widget(Button, {html : {  } ,wml : {  } ,ww : { 'text' : `four`  } }, [
