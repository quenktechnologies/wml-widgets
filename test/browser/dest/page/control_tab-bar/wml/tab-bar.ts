...
import {TabBar,Tab} from '../../../../../../lib/control/tab-bar'; ;
import {TabBarPage} from '../'; 
//@ts-ignore: 6192
import {
Maybe as __Maybe,
...
export class Main  implements __wml.View {
   ...
   constructor(__context: TabBarPage  ) {
       ...
       this.template = (__this:__wml.Registry) => {
        ...
        __this.widget(Tab, {html : {  } ,wml : {  } ,ww : { 'active' : (__context.tab === `First`) ,'text' : `First` ,'name' : `First` ,'onClick' : __context.clicked  } }, [

        
     ]),
__this.widget(Tab, {html : {  } ,wml : {  } ,ww : { 'active' : (__context.tab === `Second`) ,'text' : `Second` ,'name' : `Second` ,'onClick' : __context.clicked  } }, [

        
     ]),
__this.widget(Tab, {html : {  } ,wml : {  } ,ww : { 'active' : (__context.tab === `Third`) ,'text' : `Third` ,'name' : `Third` ,'onClick' : __context.clicked  } }, [
...
__this.widget(Demo, {html : {  } ,wml : {  } }, [
        ...
        __this.widget(TabBar, {html : {  } ,wml : {  } ,ww : { 'justify' : true   } }, [
