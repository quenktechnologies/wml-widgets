...
([
        ...
        __this.widget(new Tag({ww : { 'style' : v ,'text' : __context.values.capitalize  (v)  }}, [

        
     ]),<__wml.Attrs>{ww : { 'style' : v ,'text' : __context.values.capitalize  (v)  }})
     ]), 
()=> ([]))
     ])
     ]),<__wml.Attrs>{})
