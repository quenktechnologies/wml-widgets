...
import {PropertyList} from '../../../../../../lib/data/property-list'; ;
...
export class Main  implements __wml.View {
   ...
   constructor(__context: PropertyListPage  ) {
       ...
       this.template = (__this:__wml.Registry) => {
        ...
        __this.widget(PropertyList, {html : {  } ,wml : {  } ,ww : { 'fields' : __context.fields ,'data' : __context.data  } }, [
