...
import {FileUploadSurface} from '../../../../../../lib/control/file-upload-surface'; ;
import {FileUploadSurfacePage} from '../'; 
//@ts-ignore: 6192
import {
Maybe as __Maybe,
...
export class Main  implements __wml.View {
   ...
   constructor(__context: FileUploadSurfacePage  ) {

       this.template = (__this:__wml.Registry) => {

           return __this.widget(Demo, {html : {  } ,wml : {  } }, [

        __this.widget(FileUploadSurface, {html : {  } ,wml : {  } }, [
