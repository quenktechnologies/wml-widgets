...
export class Main  implements __wml.View {
   ...
   constructor(__context: RangedPagerPage) {
...
__this.widget(new Row({}, [
        ...
        __this.widget(new RangedPager({'max': __context.values.max,'total': __context.values.total,'current': __context.values.current,'onChange': __context.values.onChange}, [

        
     ]),<__wml.Attrs>{'max': __context.values.max,'total': __context.values.total,'current': __context.values.current,'onChange': __context.values.onChange})
     ]),<__wml.Attrs>{})
     ]),<__wml.Attrs>{})
     ]),<__wml.Attrs>{});
