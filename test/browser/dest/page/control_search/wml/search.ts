...
export class Main  implements __wml.View {
   ...
   constructor(__context: SearchPage  ) {
       ...
       this.template = (__this:__wml.Registry) => {
        ...
        __this.widget(Search, {html : {  } ,wml : { 'id' : __context.values.id   } ,ww : { 'name' : __context.values.name  ,'stringifier' : __context.values.stringifier  ,'onSearch' : __context.values.onSearch  ,'onSelect' : __context.values.onSelect   } }, [
...
__this.widget(Demo, {html : {  } ,wml : {  } }, [
        ...
        __this.widget(Search, {html : {  } ,wml : { 'id' : __context.values.id2   } ,ww : { 'name' : __context.values.name2  ,'block' : true  ,'stringifier' : __context.values.stringifier  ,'onSearch' : __context.values.onSearch  ,'onSelect' : __context.values.onSelect   } }, [
