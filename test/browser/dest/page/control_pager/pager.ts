...
export class Main  implements __wml.View {
   ...
   constructor(__context: PagerPage) {
...
__this.widget(new Row({}, [
        ...
        __this.widget(new Pager({'total': __context.values.total,'current': __context.values.current,'onChange': __context.values.onChange}, [
