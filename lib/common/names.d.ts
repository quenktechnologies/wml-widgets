 ...
 */
export declare const FIXED_PUSHABLE = "-fixed-pushable";
/**
...
export declare const DRAWER = "ww-drawer-layout";
export declare const ASIDE = "ww-drawer";
export declare const ASIDE_CONTENT = "ww-drawer__content";
