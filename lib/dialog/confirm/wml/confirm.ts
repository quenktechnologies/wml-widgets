...
export class Main  implements __wml.View {
   ...
   constructor(__context: Confirm  ) {
       ...
       this.template = (__this:__wml.Registry) => {
        ...
        __this.widget(CloseButton, {html : {  } ,wml : {  } ,ww : { 'onClick' : __context.values.footer .no .onClick   } }, [
...
__this.widget(ModalFooter, {html : {  } ,wml : {  } }, [
        ...
        __this.widget(Button, {html : {  } ,wml : {  } ,ww : { 'text' : __context.values.footer .no .text  ,'className' : __context.values.footer .no .className  ,'onClick' : __context.values.footer .no .onClick   } }, [

        
     ]),
__this.widget(Button, {html : {  } ,wml : {  } ,ww : { 'text' : __context.values.footer .yes .text  ,'className' : __context.values.footer .yes .className  ,'onClick' : __context.values.footer .yes .onClick   } }, [
