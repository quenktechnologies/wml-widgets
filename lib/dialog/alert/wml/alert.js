...
var Main = /** @class */ (function () {
    function Main(__context) {
        ...
        this.template = function (__this) {
            return __this.node('div', { html: { 'id': __context.values.id, 'class': __context.values.className }, wml: { 'id': __context.values.wml.id } }, (__context.values.content).concat((__if(__context.values.closable, function () { return ([
