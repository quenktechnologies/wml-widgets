...
export class Modal  implements __wml.View {
   ...
   constructor(__context: m.Modal  ) {
       ...
       this.template = (__this:__wml.Registry) => {
        ...
        __this.node('div', {html : { 'class' : __context.values.content .className   } ,wml : {  } }, [
...
export class ModalHeader  implements __wml.View {
...
export class ModalBody  implements __wml.View {
...
export class ModalFooter  implements __wml.View {
