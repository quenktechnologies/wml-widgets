...
class Modal extends wml_1.Component {
    constructor() {
        ...
        this.values = {
            ...
            className: util_1.concat(exports.MODAL, __1.getClassName(this.attrs)),
            content: {
...
class ModalHeader extends layout_1.AbstractLayout {
    constructor() {
        ...
        this.values = {
            ...
            id: __1.getId(this.attrs),
            className: util_1.concat(exports.MODAL_HEADER, __1.getClassName(this.attrs)),
            content: { wml: { id: 'root' } }
        };
    }
}
...
class ModalBody extends layout_1.AbstractLayout {
    constructor() {
        ...
        this.values = {
            ...
            id: __1.getId(this.attrs),
            className: util_1.concat(exports.MODAL_BODY, __1.getClassName(this.attrs)),
            content: { wml: { id: 'root' } }
        };
    }
}
...
class ModalFooter extends wml_1.Component {
    constructor() {
        ...
        this.values = {
            ...
            id: __1.getId(this.attrs),
            className: util_1.concat(exports.MODAL_FOOTER, __1.getClassName(this.attrs)),
            content: { wml: { id: 'root' } }
        };
    }
}
