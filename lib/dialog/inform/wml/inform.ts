...
export class Main  implements __wml.View {
   ...
   constructor(__context: Inform) {
       ...
       this.template = (__this:__wml.Registry) => {
        ...
        __this.widget(new CloseButton({'onClick': __context.values.footer.ok.onClick}, [

        
     ]),<__wml.Attrs>{'onClick': __context.values.footer.ok.onClick}),
...
__this.widget(new ModalFooter({}, [
        ...
        __this.widget(new Button({'text': __context.values.footer.ok.text,'className': __context.values.footer.ok.className,'onClick': __context.values.footer.ok.onClick}, [

        
     ]),<__wml.Attrs>{'text': __context.values.footer.ok.text,'className': __context.values.footer.ok.className,'onClick': __context.values.footer.ok.onClick})
     ]),<__wml.Attrs>{})
