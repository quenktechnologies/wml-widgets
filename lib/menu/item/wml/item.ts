...
export class DividerView  implements __wml.View {

   constructor(__context: Divider) {

       this.template = (__this:__wml.Registry) => {

       

           return __this.node('li', <__wml.Attrs>{'class': __context.values.className}, [
