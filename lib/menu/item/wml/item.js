...
var DividerView = /** @class */ (function () {
    function DividerView(__context) {
        this.ids = {};
        this.groups = {};
        this.views = [];
        this.widgets = [];
    ...
    DividerView.prototype.registerView = function (v) {
        this.views.push(v);
        return v;
    };
    DividerView.prototype.register = function (e, attrs) {
        var attrsMap = attrs;
        if (attrsMap.wml) {
    ...
    DividerView.prototype.node = function (tag, attrs, children) {
    ...
    DividerView.prototype.widget = function (w, attrs) {
        this.register(w, attrs);
        this.widgets.push(w);
        return w.render();
    };
    DividerView.prototype.findById = function (id) {
        var mW = maybe_1.fromNullable(this.ids[id]);
        return this.views.reduce(function (p, c) {
            return p.isJust() ? p : c.findById(id);
        }, mW);
    };
    DividerView.prototype.findByGroup = function (name) {
    ...
    DividerView.prototype.invalidate = function () {
        var tree = this.tree;
    ...
    DividerView.prototype.render = function () {
        this.ids = {};
