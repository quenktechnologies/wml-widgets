...
export declare const headings: <D>(fields: T.Field<D>[]) => (___context: T.Table<D>) => (___view: $wml.View) => Element | Node | HTMLElement;
...
export declare const rows: <D>(row: D, index: string, fields: T.Field<D>[]) => (___context: T.Table<D>) => (___view: $wml.View) => Element | Node | HTMLElement;
export declare const tbody: <D>(data: D[], fields: T.Field<D>[]) => (___context: T.Table<D>) => (___view: $wml.View) => Element | Node | HTMLElement;
