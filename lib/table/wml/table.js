...
;
exports.rows = function (rowData, rowNumber, columns) { return function (___context) { return function (___view) { return ___wml.box((___context.values.options.selectable) ? ___wml.domify(exports.rowSelectCheckbox(rowData, rowNumber)(___context)(___view)) : ___wml.domify(""), ___wml.map(columns, function _map(field) {
...
;
exports.tbody = function (data, columns) { return function (___context) { return function (___view) { return ___wml.map(data, function _map(rowData, index) {
    return ___wml.node('tr', {
        ...
        wml: {}
    }, [___wml.domify(exports.rows(rowData, index, columns)(___context)(___view))], ___view);
}, function otherwise() {
    return document.createDocumentFragment();
}); }; }; };
;
exports.table = function () { return function (___context) { return function (___view) { return ___wml.node('table', {
    ...
    }, [___wml.domify(exports.tbody(___context.values.data, ___context.values.columns)(___context)(___view))], ___view)], ___view); }; }; };
;
