...
export declare const cells: <D>(rowData: D, rowNumber: number, columns: Column<D>[]) => (___context: TableContext<D>) => (___view: ___wml.View) => ___wml.Content;
export declare const rows: <D>(data: D[], columns: Column<D>[]) => (___context: TableContext<D>) => (___view: ___wml.View) => ___wml.Content;
