...
export class DisabledLinkView  implements __wml.View {
   ...
   constructor(__context: Link) {
       ...
       this.template = (__this:__wml.Registry) => {
           ...
           return __this.node('span', <__wml.Attrs>{'id': __context.values.id,'class': __context.values.className,'href': __context.values.href,'title': __context.values.title,'onclick': __context.values.clicked}, [
...
export class LinkView  implements __wml.View {
