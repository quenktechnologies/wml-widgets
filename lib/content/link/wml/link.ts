...
export class Main  implements __wml.View {
   ...
   constructor(__context: Link  ) {
       ...
       this.template = (__this:__wml.Registry) => {
           ...
           return __this.node('a', {html : { 'id' : __context.values.a .id  ,'class' : __context.values.a .className  ,'href' : __context.values.a .href  ,'title' : __context.values.a .title  ,'disabled' : __context.values.a .disabled  ,'onclick' : __context.values.a .clicked   } ,wml : {  } }, [
