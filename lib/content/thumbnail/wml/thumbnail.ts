...
export class Thumbnail  implements __wml.View {
...
export class Anchor  implements __wml.View {

   constructor(__context: p.Thumbnail  ) {

       this.template = (__this:__wml.Registry) => {

           return __this.node('a', {html : { 'id' : __context.values.id  ,'class' : __context.values.className  ,'href' : __context.values.href  ,'onclick' : __context.values.onclick   } ,wml : {  } }, [
...
export class Caption  implements __wml.View {
