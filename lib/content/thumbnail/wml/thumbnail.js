...
var Thumbnail = /** @class */ (function () {
    function Thumbnail(__context) {
        ...
        this.template = function (__this) {
            return __this.node('div', { html: { 'id': __context.values.id, 'class': __context.values.className, 'onclick': __context.values.onclick }, wml: {} }, (__context.children).slice());
        };
    }
...
var Anchor = /** @class */ (function () {
    function Anchor(__context) {
        ...
        this.tree = document.createElement('div');
        this.template = function (__this) {
            return __this.node('a', { html: { 'id': __context.values.id, 'class': __context.values.className, 'href': __context.values.href, 'onclick': __context.values.onclick }, wml: {} }, (__context.children).slice());
        };
    }
