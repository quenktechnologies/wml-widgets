...
class Thumbnail extends wml_1.Component {
    constructor() {
        super(...arguments);
        this.view = (this.attrs.ww && this.attrs.ww.href) ?
            new views.Anchor(this) : new views.Thumbnail(this);
        this.values = {
            id: __1.getId(this.attrs),
            className: util_1.concat(exports.THUMBNAIL, __1.getClassName(this.attrs)),
...
class Caption extends wml_1.Component {
    constructor() {
        ...
        this.values = {
            id: __1.getId(this.attrs),
            className: util_1.concat(exports.THUMBNAIL_CAPTION, __1.getClassName(this.attrs))
        };
    }
}
