...
export class Main  implements __wml.View {
   ...
   constructor(__context: Image  ) {

       this.template = (__this:__wml.Registry) => {

           return __this.node('img', {html : { 'id' : __context.values.id  ,'class' : __context.values.className  ,'src' : __context.values.src  ,'alt' : __context.values.alt   } ,wml : {  } }, [
