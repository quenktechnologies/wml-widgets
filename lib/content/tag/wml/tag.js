...
var Main = /** @class */ (function () {
    function Main(__context) {
        ...
        this.template = function (__this) {
            return __this.node('span', { html: { 'id': __context.values.id, 'class': __context.values.className, 'onclick': __context.values.onclick }, wml: { 'id': __context.values.wml.id } }, (__context.values.content).slice());
        };
    }
