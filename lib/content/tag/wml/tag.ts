...
export class Main  implements __wml.View {
   ...
   constructor(__context: Tag  ) {
       ...
       this.template = (__this:__wml.Registry) => {
           ...
           return __this.node('span', <__wml.Attrs>{wml : { 'id' : __context.values.wml .id   },'id': __context.values.id ,'class': __context.values.className ,'onclick': __context.values.onclick }, [
