...
var Link = /** @class */ (function (_super) {
    ...
    function Link() {
        ...
        _this.values = {
            a: {
                id: 'root',
                class: util_1.concat(names.LINK, _this.attrs.ww ? _this.attrs.ww.class : '', (_this.attrs.ww && _this.attrs.ww.active) ?
                    classNames_1.ACTIVE : ''),
    ...
    Link.prototype.activate = function () {
        this.view.findById(this.values.a.id)
            .map(function (w) {
            w.classList.remove(classNames_1.ACTIVE);
            w.classList.add(classNames_1.ACTIVE);
        });
        return this;
    };
    /**
    ...
    Link.prototype.deactivate = function () {
        this.view.findById(this.values.a.id)
            .map(function (w) { return w.classList.remove(classNames_1.ACTIVE); });
        return this;
    };
    return Link;
}(wml.Component));
