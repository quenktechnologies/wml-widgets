...
export class Panel  implements __wml.View {

   constructor(__context: panel.Panel  ) {

       this.template = (__this:__wml.Registry) => {

           return __this.node('div', {html : { 'class' : __context.values.content .className   } ,wml : { 'id' : __context.values.content .id   } }, [
...
export class PanelHeader  implements __wml.View {
...
export class PanelBody  implements __wml.View {
...
export class PanelFooter  implements __wml.View {
