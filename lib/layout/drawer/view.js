    ...
    constructor(__context) {
        ...
        this.template = (__this) => {
            return __this.node('div', { wml: { 'id': __context.values.wml.id }, 'id': __context.values.id, 'class': __context.values.className }, [
                __this.widget(new drawer_1.Drawer({ wml: { 'id': __context.values.drawer.wml.id }, ww: { 'hidden': __context.values.drawer.hidden } }, [
                    ...(__context.values.drawer.content)
                ]), { wml: { 'id': __context.values.drawer.wml.id }, ww: { 'hidden': __context.values.drawer.hidden } }),
