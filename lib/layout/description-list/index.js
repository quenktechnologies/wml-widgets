...
class DescriptionList extends wml_1.Component {
    constructor() {
        ...
        this.values = {
            ...
            className: util_1.concat(exports.DESCRIPTION_LIST, __1.getClassName(this.attrs), (this.attrs.ww && this.attrs.ww.horizontal) ? orientation_1.HORIZONTAL : '')
        };
    }
}
...
class Title extends wml_1.Component {
    constructor() {
        ...
        this.values = {
            id: __1.getId(this.attrs),
            className: util_1.concat(exports.DESCRIPTION_LIST_TITLE, __1.getClassName(this.attrs))
        };
    }
}
exports.Title = Title;
...
class Data extends wml_1.Component {
    constructor() {
        ...
        this.values = {
            id: __1.getId(this.attrs),
            className: util_1.concat(exports.DESCRIPTION_LIST_DATA, __1.getClassName(this.attrs))
        };
    }
}
exports.Data = Data;
