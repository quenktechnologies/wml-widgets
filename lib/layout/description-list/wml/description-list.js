...
var DescriptionList = /** @class */ (function () {
    function DescriptionList(__context) {
        ...
        this.template = function (__this) {
            return __this.node('dl', { html: { 'id': __context.values.id, 'class': __context.values.className }, wml: {} }, (__context.children).slice());
        };
    }
...
var Title = /** @class */ (function () {
    function Title(__context) {
        ...
        this.tree = document.createElement('div');
        this.template = function (__this) {
            return __this.node('dt', { html: { 'id': __context.values.id, 'class': __context.values.className }, wml: {} }, (__context.children).slice());
        };
    }
...
var Data = /** @class */ (function () {
    function Data(__context) {
        ...
        this.tree = document.createElement('div');
        this.template = function (__this) {
            return __this.node('dd', { html: { 'id': __context.values.id, 'class': __context.values.className }, wml: {} }, (__context.children).slice());
        };
    }
