...
import * as m from '../';
export declare class Meter implements __wml.View {
    constructor(__context: m.Meter);
    ids: {
...
export declare class MeterBar implements __wml.View {
    constructor(__context: m.MeterBar);
    ids: {
        [key: string]: __wml.WMLElement;
    };
    groups: {
