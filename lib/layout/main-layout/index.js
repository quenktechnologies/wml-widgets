...
var orientation = require("../../../lib/content/orientation/classNames");
...
var MainLayout = /** @class */ (function (_super) {
    ...
    function MainLayout() {
        ...
        _this.values = {
            root: {
                class: util_1.concat(names.MAIN_LAYOUT, orientation.RIGHT_PUSHABLE, _this.attrs.ww ? _this.attrs.ww.class : '')
            }
        };
        return _this;
    }
