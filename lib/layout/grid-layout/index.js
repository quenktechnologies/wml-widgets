        ...
        _this.values = {
            content: {
                ...
                class: _this.attrs.ww ?
                    util_1.concat(exports.GRID_LAYOUT_COLUMN, _this.attrs.ww.span ?
                        "-span" + _this.attrs.ww.span : '-span12', _this.attrs.ww.class) : util_1.concat(exports.GRID_LAYOUT_COLUMN, '-span12')
            }
        };
        return _this;
    }
