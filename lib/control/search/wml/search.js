...
;
;
exports.populated = function (___context) { return function (option) { return function (_index) { return function (_options) { return function (___view) { return ___wml.domify(___context.values.item.decorator(option)); }; }; }; }; };
;
