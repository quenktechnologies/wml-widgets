    ...
    constructor() {
        ...
        this.values = {
            root: {
                ...
                className: util_1.concat(exports.DATE_FIELD, __1.getClassName(this.attrs), orientation_1.getBlockClassName(this.attrs), feedback_1.getValidityClassName(this.attrs)),
            },
            control: {
                wml: { id: 'input' },
                id: __1.getId(this.attrs)
            ...
            input: {
                ...
                moment: ((this.attrs.ww && this.attrs.ww.value) ?
                    maybe_1.just(parseDate(getValue(this.attrs), getFormat(this.attrs))) :
                    maybe_1.nothing()),
                ...
                onkeyup: util_1.debounce((e) => {
                    let value = e.target.value;
                    if (value === '') {
                        this.values.input.moment = maybe_1.nothing();
                        this.fireChange();
                    }
                    else {
                        let m = parseDate(value, this.values.input.format);
                        if (m.isValid()) {
                            this.values.input.moment = maybe_1.just(m);
                            this.fireChange();
                        }
                    }
                }, exports.DELAY),
    ...
    fireChange() {
        if (this.attrs.ww && this.attrs.ww.onChange) {
            ...
            if (this.values.input.moment.isJust()) {
                ...
                if (m.isValid())
                    this.attrs.ww.onChange(new DateChangedEvent(name, m.format(exports.VALUE_FORMAT)));
            }
            else {
...
const getValue = (attrs) => (attrs.ww && attrs.ww.value) ? attrs.ww.value : '';
...
const getDisplay = (attrs) => (attrs.ww && attrs.ww.display) ? attrs.ww.display : exports.DEFAULT_INPUT_DISPLAY;
