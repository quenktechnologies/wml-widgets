...
var DateField = /** @class */ (function (_super) {
    ...
    function DateField() {
        ...
        _this.values = {
            root: {
                ...
                className: util_1.concat(exports.DATE_FIELD, __1.getClassName(_this.attrs), feedback_1.getVSClassNameFromAttrs(_this.attrs)),
            },
            control: {
                wml: {
                    id: 'root'
    ...
    DateField.prototype.fire = function (value) {
        if (this.attrs.ww && this.attrs.ww.onChange)
            this.attrs.ww.onChange(new DateChangedEvent(this.values.name, value.format('ll')));
    };
    return DateField;
