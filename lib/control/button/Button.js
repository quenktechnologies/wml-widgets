...
var Button = /** @class */ (function (_super) {
        ...
        _this.values = {
            button: {
                ...
                class: _this.attrs.ww ?
                    util_1.concat(Button.CLASS_NAME, _this.attrs.ww.class, _this.attrs.ww.style || Button.styles.DEFAULT, _this.attrs.ww.size && _this.attrs.ww.size, _this.attrs.ww.outline && classNames_1.features.OUTLINE, _this.attrs.ww.block && classNames_1.features.BLOCK, _this.attrs.ww.active && classNames_1.states.ACTIVE) :
                    Button.CLASS_NAME,
     ...
     * NAME
     */
    Button.CLASS_NAME = _1.BUTTON;
    /**
     * styles the Button supports.
     */
    Button.styles = classNames_1.styles;
    return Button;
}(wml.Component));
