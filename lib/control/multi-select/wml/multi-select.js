    ...
    function Main(___context) {
        ...
        _this.template = function (___view) {
            return ___wml.node('div', {
                ...
                wml: {}
            }, [___wml.domify(wml_1.label(___context.values.label.id)(___context.values.label.text)(___view)), ___wml.widget(select_1.Select, {
                    html: {},
                    wml: {
                ...
                }, [], ___view), ___wml.domify(wml_1.message(___context.values.messages.id)(___context.values.messages)(___view))], ___view);
        };
        return _this;
    }
    return Main;
