    ...
    function Main(__context) {
        ...
        this.template = function (__this) {
            return __this.node('div', { html: { 'id': __context.values.root.id, 'class': __context.values.root.className }, wml: {} }, [
                ...
                __this.node('div', { html: { 'onclick': __context.values.content.onfocus, 'class': __context.values.content.className }, wml: {} }, (__if(__context.values.tags.has(), function () { return (__forIn(__context.values.tags.value, function (value, idx, _$$all) {
                    return ([
                ...
                }, function () { return ([]); }).slice()); }, function () { return ([
                    __1.text("")
                ]); })).concat([
