...
exports.button = function (d) { return function (__this) {
    return [
        __this.widget(new button_1.Button({ ww: { 'className': d.values.button.className, 'style': d.values.button.style, 'disabled': d.values.button.disabled, 'onClick': d.values.button.onClick } }, [
            __1.text((d.values.button.text + ' ')),
            __this.widget(new caret_1.Caret({}, []), {})
        ]), { ww: { 'className': d.values.button.className, 'style': d.values.button.style, 'disabled': d.values.button.disabled, 'onClick': d.values.button.onClick } })
    ];
}; };
;
