...
class ButtonView {
    constructor(__context) {
        ...
        this.template = (__this) => {
            return __this.widget(new button_1.Button({ ww: { 'className': __context.values.button.className, 'anchor': __context.values.button.anchor, 'disabled': __context.values.button.disabled, 'onClick': __context.values.button.onClick } }, [
                text((__context.values.button.text + ' ')),
                __this.widget(new caret_1.Caret({}, []), {})
            ]), { ww: { 'className': __context.values.button.className, 'anchor': __context.values.button.anchor, 'disabled': __context.values.button.disabled, 'onClick': __context.values.button.onClick } });
        };
    }
    registerView(v) {
        this.views.push(v);
