...
exports.button = function (d) { return function (__this) {
    return __spreadArrays((__if((d.values.button.anchor === true), function () { return ([
        __this.node('a', { 'class': d.values.button.className, 'disabled': d.values.button.disabled, 'onclick': d.values.button.onClick }, [
            __1.text((d.values.button.text + ' ')),
            __this.widget(new caret_1.Caret({}, []), {})
        ])
    ]); }, function () { return ([
        __this.widget(new button_1.Button({ ww: { 'className': d.values.button.className, 'disabled': d.values.button.disabled, 'onClick': d.values.button.onClick } }, [
            __1.text((d.values.button.text + ' ')),
            __this.widget(new caret_1.Caret({}, []), {})
        ]), { ww: { 'className': d.values.button.className, 'disabled': d.values.button.disabled, 'onClick': d.values.button.onClick } })
    ]); })));
}; };
;
