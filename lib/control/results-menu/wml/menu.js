...
var Main = /** @class */ (function () {
    function Main(__context) {
        ...
        this.template = function (__this) {
            return __this.widget(menu_1.Menu, { html: {}, wml: { 'id': __context.values.wml.id }, ww: { 'name': __context.values.name, 'block': __context.values.block, 'hidden': __context.values.hidden } }, __forIn(__context.values.results, function (result, index, _$$all) {
                return ([
                    __this.widget(item_1.Item, { html: {}, wml: {}, ww: { 'name': ("" + index) } }, [
                        __this.widget(link_1.Link, { html: {}, wml: {}, ww: { 'onClick': function () { return __context.values.item.click(index); } } }, (__context.values.item.template()(result)(index)(__this)).slice())
                    ])
                ]);
            }, function () { return ((__context.values.item.noItemsTemplate()(__this)).slice()); }).slice());
        };
    }
