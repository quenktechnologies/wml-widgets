...
export interface ItemTemplateViewContext {
    option: string;
}
export declare class ItemTemplateView implements __wml.View {
    constructor(__context: ItemTemplateViewContext);
    ids: {
...
export declare class NoItemsTemplateView implements __wml.View {
