...
export declare const itemTemplate: <V>(r: ResultsMenu<V>, option: V, _index: number) => (__this: __wml.Registry) => import("@quenk/wml").Content[];
export declare const noItemsTemplate: () => (__this: __wml.Registry) => import("@quenk/wml").Content[];
