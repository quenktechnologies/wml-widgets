...
export interface ItemTemplateViewContext{option : string};
export class ItemTemplateView  implements __wml.View {
...
export class NoItemsTemplateView  implements __wml.View {
