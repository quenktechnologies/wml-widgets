 ...
 * getName
 */
exports.getName = (attrs) => (attrs.ww && attrs.ww.name) ? attrs.ww.name : '';
/**
 * getDisabled
 */
exports.getDisabled = (attrs) => (attrs.ww && attrs.ww.disabled) ? attrs.ww.disabled : undefined;
/**
 * getValue
 */
exports.getValue = (attrs) => (attrs.ww && attrs.ww.value) ? maybe_1.just(attrs.ww.value) : maybe_1.nothing();
