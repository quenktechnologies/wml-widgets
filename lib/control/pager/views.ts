...
export class PagerView  implements __wml.View {
   ...
   constructor(__context: Pager) {
       ...
       this.template = (__this:__wml.Registry) => {
           ...
           return __this.node('nav', <__wml.Attrs>{'id': __context.values.id,'class': __context.values.className}, [

        __this.node('ul', <__wml.Attrs>{}, [
