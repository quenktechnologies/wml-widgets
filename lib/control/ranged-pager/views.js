                ...
                ...__forIn(__context.values.pages, (idx, _$$i, _$$all) => ([
                    __this.node('li', { 'class': __context.values.page.getClassName(idx) }, [
                        ...(((idx === 0)) ?
                            ...
                            (() => ([
                                __this.widget(new link_1.Link({ ww: { 'className': '-ww-no-decoration', 'text': String(idx), 'onClick': () => __context.values.page.onClick(idx) } }, []), { ww: { 'className': '-ww-no-decoration', 'text': String(idx), 'onClick': () => __context.values.page.onClick(idx) } })
                            ]))())
                    ])
                ]), () => ([]))
