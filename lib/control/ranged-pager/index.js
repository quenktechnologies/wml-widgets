...
class RangedPager extends wml_1.Component {
    constructor() {
        ...
        this.values = {
            ...
            className: util_1.concat(exports.RANGED_PAGER, this.attrs.className),
            ...
            page: {
                getClassName: (i) => util_1.concat(exports.RANGED_PAGER_PAGE, (i === this.values.current) ? active_1.ACTIVE : ''),
                onClick: (i) => {
    ...
    fire() {
        ...
        util_1.getById(this.view, "pager").map(w => w.view.invalidate());
...
const paginate = (max, total, current) => {
    let allPages = array_1.make(total, i => i + 1);
