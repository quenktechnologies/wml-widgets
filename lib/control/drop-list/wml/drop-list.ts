...
export class Main <V  >  implements __wml.View {
   ...
   constructor(__context: DropList<V  > ) {
       ...
       this.template = (__this:__wml.Registry) => {
        ...
        __this.widget(new DisplayField({'onClick': __context.values.display.onClick,'disabled': __context.values.display.disabled}, [
...
__this.widget(new Caret({}, [
     ...
     ]),<__wml.Attrs>{'onClick': __context.values.display.onClick,'disabled': __context.values.display.disabled}),
