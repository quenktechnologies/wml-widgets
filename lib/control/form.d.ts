 ...
 * Set
 */
export declare type Set<V, A extends FormControlAttrs<V>> = (val: V) => FormControl<V, A>;
/**
 ...
 * FormControl.
 */
export declare abstract class GenericFormControl<V, A extends FormControlAttrs<V>> extends GenericFeedbackControl<V, A> {
}
