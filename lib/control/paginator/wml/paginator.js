    ...
    function Main(__context) {
        ...
        this.template = function (__this) {
            return __this.node('ul', { html: { 'id': __context.values.id, 'class': __context.values.className }, wml: {} }, [
                __this.node('li', { html: { 'class': __context.values.first.className }, wml: {} }, (__if(__context.values.first.isDisabled(), function () { return ([
                    __this.node('span', { html: {}, wml: {} }, [])
                ]); }, function () { return ([
                    __this.node('a', { html: { 'href': "#", 'onclick': __context.values.first.onclick }, wml: {} }, [])
                ]); })).slice()),
                __this.node('li', { html: { 'class': __context.values.previous.className }, wml: {} }, (__if(__context.values.previous.isDisabled(), function () { return ([
                    __this.node('span', { html: {}, wml: {} }, [])
                ]); }, function () { return ([
                ...
                __this.node('li', { html: { 'class': __context.values.next.className }, wml: {} }, (__if(__context.values.next.isDisabled(), function () { return ([
                    __this.node('span', { html: {}, wml: {} }, [])
                ]); }, function () { return ([
                    __this.node('a', { html: { 'href': "#", 'onclick': __context.values.next.onclick }, wml: {} }, [])
                ]); })).slice()),
                __this.node('li', { html: { 'class': __context.values.last.className }, wml: {} }, (__if(__context.values.last.isDisabled(), function () { return ([
                    __this.node('span', { html: {}, wml: {} }, [])
                ]); }, function () { return ([
