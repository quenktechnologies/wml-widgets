...
class InputGroup extends wml_1.Component {
    constructor() {
        ...
        this.values = {
            ...
            className: util_1.concat(exports.INPUT_GROUP, __1.getClassName(this.attrs)),
        };
    }
}
...
class AddOn extends wml_1.Component {
    constructor() {
        ...
        this.values = {
            id: __1.getId(this.attrs),
            className: util_1.concat(this.attrs.button ?
                exports.INPUT_GROUP_BUTTON_ADDON :
                exports.INPUT_GROUP_ADDON, __1.getClassName(this.attrs)),
        };
    }
}
exports.AddOn = AddOn;
