    ...
    constructor() {
        ...
        this.values = {
            root: {
                ...
                className: util_1.concat(exports.SWITCH, __1.getClassName(this.attrs))
            },
            slider: {
            ...
            input: {
                ...
                disabled: __2.getDisabled(this.attrs),
                onChange: () => {
                    this.values.input.value = (!this.values.input.value);
                    if ((this.attrs.ww && this.attrs.ww.onChange))
                        this.attrs.ww.onChange(new SwitchChangedEvent(this.values.input.name, this.values.input.value));
                }
            }
        };
    }
