...
;
exports.populated = function (option, _index, _options) { return function (___context) { return function (___view) { return $wml.domify(___context.values.item.stringify(option)); }; }; };
;
