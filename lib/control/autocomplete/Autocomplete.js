...
var Autocomplete = /** @class */ (function (_super) {
            ...
            item: {
                ...
                click: function (index) {
                    _this
                        .close()
                        .delegate
                        .onSelect(new search_control_1.ItemSelectedEvent(_this.attrs.ww.name, _this.values.search.results[Number(index)]));
                }
            }
        };
        return _this;
    ...
    Autocomplete.prototype.value = function () {
        throw new Error('Autocomplete: value() is not yet implemented!');
    };
    return Autocomplete;
}(search_control_1.SearchControlWidget));
