...
var Main = /** @class */ (function () {
    function Main(__context) {
        ...
        this.template = function (__this) {
            return __this.node('span', { html: { 'id': __context.values.help.id, 'class': __context.values.help.className }, wml: { 'id': __context.values.help.wml.id } }, (__context.values.help.text).slice());
        };
    }
