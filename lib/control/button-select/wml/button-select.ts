...
export class Main <V  >  implements __wml.View {
   ...
   constructor(__context: ButtonSelectInterface <V  >  ) {
       ...
       this.template = (__this:__wml.Registry) => {
           ...
           return __this.widget(ButtonGroup, {html : { 'id' : __context.values.root .id  ,'class' : __context.values.root .className   } ,wml : {  } }, [

        ...__forIn (__context.values.buttons .options , (opt: Option <V  >   , idx , _$$all)=> 
([

        __this.widget(Button, {html : {  } ,wml : {  } ,ww : { 'class' : __context.values.buttons .getClassNames (idx) ,'active' : __context.values.buttons .getActive (idx) ,'style' : __context.values.buttons .getStyle () ,'onClick' : () => __context.values.buttons .click (idx) ,'text' : opt.text  } }, [
