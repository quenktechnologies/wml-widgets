...
var Main = /** @class */ (function () {
    function Main(__context) {
        ...
        this.template = function (__this) {
            return __this.widget(t.Tag, { html: {}, wml: {}, ww: { 'id': __context.values.id, 'className': __context.values.className, 'style': __context.values.style } }, (__if((__context.values.text.value !== ""), function () { return ([
