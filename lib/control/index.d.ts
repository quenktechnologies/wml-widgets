 ...
 */
export declare abstract class AbstractControl<V, A extends ControlAttrs<V>> extends Component<A> implements Control<V, A> {
}
/**
 * getName
 */
export declare const getName: <V>(attrs: ControlAttrs<V>) => string;
/**
 * getDisabled
 */
export declare const getDisabled: <V>(attrs: ControlAttrs<V>) => boolean;
/**
 * getValue
 */
export declare const getValue: <V>(attrs: ControlAttrs<V>) => Maybe<V>;
