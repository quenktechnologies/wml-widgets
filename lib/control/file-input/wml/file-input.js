...
var FileInputView = /** @class */ (function () {
    function FileInputView(__context) {
        ...
        this.template = function (__this) {
            return __this.node('input', { 'id': __context.values.id, 'class': __context.values.className, 'name': __context.values.name, 'type': 'file', 'accept': __context.values.accept, 'onchange': __context.values.change }, []);
        };
    }
