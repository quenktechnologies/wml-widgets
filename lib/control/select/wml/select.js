    ...
    function Main(__context) {
        ...
        this.template = function (__this) {
            return __this.node('div', { 'id': __context.values.root.id, 'class': __context.values.root.className }, __spreadArrays([
                ...
                __this.widget(new tag_1.Tag({ ww: { 'text': __context.values.tag.getText(), 'className': __context.values.tag.className, 'onDismiss': __context.values.tag.dismiss } }, []), { ww: { 'text': __context.values.tag.getText(), 'className': __context.values.tag.className, 'onDismiss': __context.values.tag.dismiss } })
            ]); }, function () { return ([
