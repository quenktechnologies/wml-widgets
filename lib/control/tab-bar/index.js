    ...
    constructor() {
        ...
        this.values = {
            root: {
                ...
                className: util_1.concat(exports.TAB, __1.getClassName(this.attrs), (this.attrs.ww && this.attrs.ww.active) ? active_1.ACTIVE : ''),
            },
            a: {
                wml: {
                    id: 'link'
                ...
                clicked: (e) => {
                    e.preventDefault();
                    let maybeRoot = util_1.getById(this.view, this.values.root.wml.id);
                    ...
                    if (this.attrs.ww && this.attrs.ww.onClick)
                        this.attrs.ww.onClick(new TabClickedEvent(`${this.attrs.ww.name}`));
                }
            }
        };
    }
...
class TabBar extends wml_1.Component {
    constructor() {
        ...
        this.values = {
            root: {
                id: __1.getId(this.attrs),
                className: util_1.concat(exports.TAB_BAR, __1.getClassName(this.attrs), (this.attrs.ww && this.attrs.ww.justify) ? orientation_1.JUSTIFIED : '')
            }
        };
    }
}
