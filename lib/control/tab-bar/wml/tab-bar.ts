...
export class TabBar  implements __wml.View {

   constructor(__context: tabbar.TabBar  ) {
...
export class Tab  implements __wml.View {

   constructor(__context: tabbar.Tab  ) {
       ...
       this.template = (__this:__wml.Registry) => {
        ...
        __this.node('a', {html : { 'href' : `#` ,'onclick' : __context.values.a .clicked   } ,wml : { 'id' : __context.values.a .wml .id   } }, [
