...
var Tab = /** @class */ (function (_super) {
    ...
    function Tab() {
        ...
        _this.values = {
            root: {
                id: 'root',
                class: util_1.concat(names.TAB_BAR_TAB, _this.attrs.ww.active ? classNames_1.states.ACTIVE : ''),
            },
            a: {
                id: 'link',
                ...
                clicked: function (e) {
                    ...
                    _this
                        ...
                        for (var i = 0; i < us.length; i++)
                            us[i].classList.remove(classNames_1.states.ACTIVE);
                        return _this
                            .view
                            .findById(_this.values.root.id)
                            .map(function (el) { return el.classList.add(classNames_1.states.ACTIVE); })
