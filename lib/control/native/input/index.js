...
var Values = /** @class */ (function () {
    function Values(self, wml, id, className, name, type, placeholder, value, disabled, readOnly, oninput) {
        if (wml === void 0) { wml = { id: 'root' }; }
        if (id === void 0) { id = __2.getId(self.attrs); }
        if (className === void 0) { className = util_1.concat(exports.NATIVE_INPUT, __2.getClassName(self.attrs)); }
