    ...
    function HeadView(__context) {
        ...
        this.template = function (__this) {
            return __this.node('thead', { html: { 'class': __context.className }, wml: {} }, [
                __this.node('tr', { html: {}, wml: {} }, __forIn(__context.columns, function (col, idx, _$$all) {
                    return ([
...
var BodyView = /** @class */ (function () {
    function BodyView(__context) {
        ...
        this.tree = document.createElement('div');
        this.template = function (__this) {
            return __this.node('tbody', { html: { 'class': __context.className }, wml: {} }, __forIn(__context.data, function (_, row, _$$all) {
                return ([
                    __this.node('tr', { html: {}, wml: {} }, __forIn(__context.columns, function (col, idx, _$$all) {
                        return ([
...
var CellView = /** @class */ (function () {
    function CellView(__context) {
        ...
        this.tree = document.createElement('div');
        this.template = function (__this) {
            return __this.node('td', { html: { 'class': __context.className, 'onclick': __context.onclick }, wml: {} }, [
