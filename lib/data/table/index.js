...
var NewHeadContext = /** @class */ (function () {
    function NewHeadContext(table) {
        ...
        this.heading = function (c) { return function (i) {
            return getHeadingFragment(_this.table)(new NewHeadingContext(_this.table, c, i));
        }; };
    }
    ...
    function NewHeadingContext(table, column, index) {
        ...
        this.onclick = function (_) {
            if (_this.column.sort) {
                if (_this.table.values.sortKey[0] === _this.index)
                    _this.table.reverse();
                else
                    _this.table.sort(_this.index);
            }
            if (_this.table.attrs.ww && _this.table.attrs.ww.onHeadingClicked)
                _this.table.attrs.ww.onHeadingClicked(new HeadingClickedEvent(_this.index));
        };
    }
...
var NewBodyContext = /** @class */ (function () {
    function NewBodyContext(table) {
        ...
        this.cell = function (c) { return function (id) { return function (row) {
            return getCellFragment(_this.table)(new NewCellContext(_this.table, c, id, row));
        }; }; };
    }
    ...
    function NewCellContext(table, spec, column, row) {
        ...
        this.onclick = function () {
            if (_this.table.attrs.ww && _this.table.attrs.ww.onCellClicked)
                _this.table.attrs.ww.onCellClicked(new CellClickedEvent(_this.column, _this.row));
        };
    }
...
var DataTable = /** @class */ (function (_super) {
    ...
    function DataTable() {
        ...
        _this.values = {
            ...
            thead: function () {
                return getHeadFragment(_this)(new NewHeadContext(_this));
            },
            tbody: function () {
                return getBodyFragment(_this)(new NewBodyContext(_this));
            }
        };
        return _this;
    }
    ...
    DataTable.prototype.fireChange = function () {
        if (this.attrs.ww && this.attrs.ww.onChange)
            this.attrs.ww.onChange(new DataChangedEvent(this.values.dataset[0].slice()));
    };
    /**
    ...
    DataTable.prototype.sort = function (id) {
        var spec = this.values.columns[id];
        if (spec === undefined)
            return this;
        if (!spec.sort)
            return this;
    ...
    DataTable.prototype.reverse = function () {
        ...
        this.values.sortKey =
            [this.values.sortKey[0], this.values.sortKey[1] * -1];
        this.fireChange();
        this.view.invalidate();
        return this;
    };
...
var defaultHeadFragment = function (c) { return new views.HeadView(c).render(); };
var getHeadingFragment = function (table) {
    return (table.attrs.ww && table.attrs.ww.headingFragment) ?
        table.attrs.ww.headingFragment :
        defaultHeadingFragment;
};
var defaultHeadingFragment = function (c) { return new views.HeadingView(c).render(); };
var getBodyFragment = function (table) {
    return (table.attrs.ww && table.attrs.ww.bodyFragment) ?
        table.attrs.ww.bodyFragment :
        defaultBodyFragment;
};
var defaultBodyFragment = function (c) { return new views.BodyView(c).render(); };
var getCellFragment = function (table) {
    return (table.attrs.ww && table.attrs.ww.cellFragment) ?
        table.attrs.ww.cellFragment :
        defaultCellFragment;
};
var defaultCellFragment = function (c) { return new views.CellView(c).render(); };
