...
var Main = /** @class */ (function () {
    function Main(__context) {
        ...
        this.template = function (__this) {
            return __this.widget(description_list_1.DescriptionList, { html: {}, wml: {}, ww: { 'className': __context.values.root.className } }, __forIn(__context.values.fields, function (field, _$$i, _$$all) {
                return ([
                    __this.widget(description_list_1.Title, { html: {}, wml: {} }, [
                        __1.text(field.heading)
                    ]),
                    __this.widget(description_list_1.Data, { html: {}, wml: {} }, (__context.values.data.get(field)).slice())
                ]);
